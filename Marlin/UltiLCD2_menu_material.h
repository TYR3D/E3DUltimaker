...
#define FILAMENT_REVERSAL_LENGTH      (FILAMANT_BOWDEN_LENGTH + 150) // [E3D]
#define FILAMENT_REVERSAL_SPEED       75 // [E3D]
...
#define FILAMENT_INSERT_FAST_SPEED    75   //Speed during the forward length [E3D]
